...
## Priv-esc
----
We've established access as `Lainey` and identified `Greg` (the Sys Admin) as our next target. Checking Lainey's group memberships reveals they belong to `RDP Users` and `WinRM Remote Management`.
