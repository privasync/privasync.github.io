...
description: "Synack - Medium-rate Active Directory Machine by Luis M."
published: true
---
...
![Visiting Site](/assets/lib/img/SyscoMSP.png)
*Index.html* 

![Team](/assets/lib/img/Team.png)
...
```
![FFUF](/assets/lib/img/Ffuf.png)
*FFUF Output*
- we see a `301` for RoundCube. 

I also did vhost fuzzing on `SYSCO.LOCAL` and got nothing.
